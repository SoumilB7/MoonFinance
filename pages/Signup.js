      ...
      <div className="min-h-screen w-0 bg-blue-500 md:w-1/2">
        <div className="flex justify-center mt-16">
          <svg width="245" height="245" viewBox="0 0 245 245" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M163.47 47.3831L173.509 69.4838L119.881 93.5966L126.588 109.292L180.594 84.2649L190.188 105.874L206.064 61.9018L163.47 47.3831Z" fill="white" />
            <path d="M125.465 152.691V131.89L176.135 108.777V128.423L125.465 152.691Z" fill="white" />
            <path d="M68.7393 64.894L130.688 102.55" stroke="white" stroke-width="15.8065" />
        ...
        <div className="flex column flex-start mb-12">
              ...
              <svg width="20" height="20" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_1020_16)">
                  ...
                  <path
                    ...
                    fill="#E33629"
                  />
                  <path d="M0.993038 15.6914C1.33228 14.0088 1.89591 12.3794 2.66882 10.8469L8.98499 15.7493C8.15895 18.1826 8.15895 20.8204 8.98499 23.2537C6.88062 24.8787 4.77523 26.5119 2.66882 28.1531C0.734513 24.3028 0.144583 19.9159 0.993038 15.6914Z" fill="#F8BD00" />
                  <path
          ...
          <button onClick={() => {setIsOpen(!isOpen);router.push('/Login')}} className="ml-12 mt-4">
            <svg width="80" height="30" viewBox="0 0 122 41" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              />
              <path d="M2.9998 20.6471H31.6763M31.6763 20.6471L25.0586 14.0294M31.6763 20.6471L25.0586 27.2647" stroke="white" stroke-width="4.41177" stroke-linecap="round" stroke-linejoin="round" />
              <path
