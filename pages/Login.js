        ...
        <form onSubmit={handleSubmit} method="POST">
          <div className="mt-2 flex justify-center">
            <input
              ...
              autoComplete="email"
              required
              className="bg-black text-white block py-1.5 px-3 mt-9 border-b-2 sm:text-sm w-max"
              value={email}
          ...
          <div className=" flex justify-center">
            <input
              ...
              required
              className="bg-black text-white block border-b-2 py-1.5 px-3 mt-6 sm:text-sm w-max"
              value={password}
