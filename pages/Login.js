...
const Login = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-black">
      <div className="text-6xl font-sans font-semibold text-center mt-16">
        <label>Welcome!</label>
      </div>
      <form onSubmit={handleSubmit} method="POST">
        <div className="mt-2 flex justify-center">
          <input
            ...
            autoComplete="email"
            required
            className="bg-black block w-1/4 py-1.5 px-3 mt-9 border-b-2 sm:text-sm"
            value={email}
        ...
        <div className=" flex justify-center">
          <input
            ...
            required
            className="bg-black block w-1/4 border-b-2 py-1.5 px-3 mt-6 sm:text-sm"
            value={password}
        ...
        <div className="flex justify-center mt-2">
          <button onClick={() => setIsOpen(!isOpen)} className="">
            ...
            >
              <path
                d="M27.2888 37.3776C25.1726 39.429 22.862 39.1051 20.6378 38.1334C18.284 37.1401 16.1246 37.0969 13.6413 38.1334C10.5317 39.4722 8.89053 39.0835 7.03342 37.3776C-3.50458 26.5157 -1.94979 9.97448 10.0134 9.36984C12.9287 9.521 14.9585 10.9678 16.6645 11.0974C19.2126 10.5791 21.6527 9.08911 24.3736 9.28346C27.6343 9.54259 30.0961 10.8382 31.7157 13.1704C24.9783 17.2086 26.5762 26.0838 32.7522 28.5671C31.5213 31.8063 29.9233 35.0238 27.2672 37.3992L27.2888 37.3776ZM16.4485 9.24027C16.1246 4.42475 20.0332 0.45141 24.5248 0.0627136C25.151 5.63403 19.4717 9.78013 16.4485 9.24027Z"
                fill="white"
              />
            </svg>
          </button>
          <button onClick={() => setIsOpen(!isOpen)} className="inline-block ml-3">
            <svg
              width="20"
              height="20"
              viewBox="0 0 39 39"
        ...
        <div className="flex justify-center mt-4">
            <p>Don't you have an account? <span className="text-blue-400">Sign up</span></p>
        </div>
      </form>
    </div>
  );
