  ...
  return (
    <>
      <div className="h-screen bg-black text-white font-poppins">
        <div className="text-6xl mt-[2%] w-full text-center px-6 font-semibold md:text-left max-sm:px-20 max-sm:text-5xl md:font-bold max-sm:pt-6 text-nowrap">Your Assets</div>
        <div className="grid grid-rows-2 md:grid-cols-2 font-poppins">
          ...
          <div className="grid grid-cols-2 grid-rows-2 mx-auto my-auto -mt-[10%] gap-x-10 gap-y-10 md:mt-[20%] pl-10">
            ...
            <div className="md:-mt-20 mx-10">
              {/*PRice Invested*/}
              <p className="text-2xl font-normal md:font-normal md:text-4xl">Price Invested</p>
              <p className="text-blue-500 text-2xl font-medium">{priceInvested}</p>
            </div>

            <div className="md:-mt-20">
              {/*CAGR*/}
              <p className="text-2xl font-normal md:font-normal md:text-4xl">CAGR</p>
              <p className="text-blue-500 text-2xl font-medium">{cagr}%</p>
            </div>

            <div className="md:hidden text-nowrap pt-2 mx-10">
              {/*Assets*/}
              <p className="text-2xl font-normal md:font-normal md:text-4xl">Risk Profile</p>
            ...
            <div className="max-md:hidden flex-row w-[180%] mb-8 pl-10">
              {' '}
              {/* Laptop Paragraph */}
              <p className="text-3xl font-bold text-nowrap pt-[10%]">About the allocation</p>
              <p className="pt-4 font-medium text-wrap text-2xl">We have analysed your investor profile i.e Your risk apetite, stability preference and many other factors which helps us decide your favourable investments. Every investor has a unique profile and this one suits you the best !</p>
            </div>
            ...
            <button
              ...
              className="w-[200px] h-[50px] bg-blue-500 mx-[40%] md:-mx-[310%] md:mt-[70%] lg:-mx-[270%] lg:mt-[80%] text-xl rounded-lg hover:bg-blue-700">
              Customise Assets
            </button>
          </div>
        </div>
        ...
        <div className="w-full text-center md:hidden flex-row justify-center max-sm:px-6 -mt-[25%] pt-2 font-poppins">
          {/*Paragraph*/}
          <p className="text-4xl font-medium max-sm:text-3xl sm:pt-10">About the allocation</p>
