...
const Solution = () => {
  return (
    <div className="min-h-[55vh] bg-[#0455BF] flex flex-col md:flex-row items-center justify-center">
      <div className="m-10 w-full md:w-2/3 p-5 md:p-10 pl-[2rem] md:pl-[6rem]">
        <h1 className='text-5xl md:text-7xl font-bold'>Our Solution</h1>
      ...
      <div className='hidden w-full md:w-1/3 py-10 md:flex flex-row justify-center'>
